      ...
      <div className="relative">
        ...
        >
          {restaurants.map((restaurant, index) => (
            <div key={restaurant.id} className="min-w-[84vw] snap-start sm:min-w-[45vw] lg:min-w-[27%]">
        ...
        <div className="pointer-events-none absolute inset-y-0 right-0 w-24 bg-linear-to-l from-bgLight to-transparent" />
      </div>
    </section>
  )
}