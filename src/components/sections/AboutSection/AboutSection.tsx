...
export function AboutSection() {
  return (
    <section id="chi-siamo" className="bg-bgLight py-20">
      <div className="mx-auto max-w-7xl px-6">
        <h2 className="mb-8 text-2xl font-semibold text-textDark">Chi siamo?</h2>
        <div className="grid gap-8 md:grid-cols-2">
          <AnimateOnScroll animation="slide-left">
          <div>
            <p className="text-6xl font-serif leading-none text-accent md:text-8xl">"</p>
            <p className="text-xl italic text-textDark">
          ...
          <div className="flex flex-col justify-between text-textDark/80">
            <p>
